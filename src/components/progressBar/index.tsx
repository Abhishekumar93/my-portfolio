...
const ProgressBar = ({ progressData, isLastData }: IProgressBar) => {
  ...
  return (
    ...
    >
      ...
      <div className="h-3 rounded-[0.625rem] dark:bg-[#212428] bg-[#dce1e4] shadow-none dark:shadow-progress_bar">
        <div
          className="animate-progressBarFadeLeft ease-in-out progress_bar_bg relative h-full rounded-[0.625rem]"
