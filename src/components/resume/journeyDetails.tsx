          ...
          return (
            ...
            >
              <div className="journey_detail_card_inner after:absolute after:content-[''] after:w-5 after:h-5 after:border-[5px] after:border-solid after:border-[#d9dee2] dark:after:border-[#17191c] after:rounded-[100%] after:right-[104%] after:top-14 after:-translate-y-[7px] after:bg-[#ecf0f3] dark:after:bg-[#222529] after:duration-[0.4s] hover:after:bg-red_primary">
                ...
                <p className="text-dark_text dark:text-light group-hover:text-white group-hover:duration-[0.4s] text-lg">
                  {detail?.description}
                </p>
              </div>
            </div>
